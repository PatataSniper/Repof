...
class Analisis:
    def __init__(self, tabla: Table, clase):
        ...
        # self.tabla_remp_tot = self.obtiene_tabla_remp() # Tabla reemplazada en su totalidad
        #  (con los valores faltantes reemplazados para todos los atributos de la tabla)
    ...
    def obtiene_atr_clase(self):
        ...
        for atr in self.tabla.properties.propsAttr:
            if atr['type'] in self.tipos_clase:
                # Sabemos que el atributo actual es categórico, lo agregamos a la lista
